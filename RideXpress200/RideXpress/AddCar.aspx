<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/RideXpress.Master" AutoEventWireup="true" CodeBehind="AddCar.aspx.cs" Inherits="RideXpress_StarterKit.AddCar" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    <div class="col-xs-4 col-xs-offset-4">
                        <asp:Button ID="CarAddButton" runat="server" Text="Submit" CssClass="btn btn-success"
                            OnClick="CarAddButton_Click" ValidationGroup="AllValidators" />
